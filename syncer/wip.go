...
func (s *Syncer) SetPinnedStatusInfo(puzzle *schema.Puzzle, channelID string) (didUpdate bool, err error) {
	...
	return s.discord.CreateUpdatePin(channelID, pinnedStatusHeader, embed)
}
